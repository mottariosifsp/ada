# Generated by Django 4.1.7 on 2023-09-02 13:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone', models.CharField(blank=True, max_length=11, null=True, unique=True, verbose_name='telephone')),
                ...
                ('is_fgfcc', models.BooleanField(default=False, verbose_name='fgfcc')),
                ('is_professor', models.BooleanField(default=False, verbose_name='professor')),
                ('job', models.CharField(blank=True, choices=[('TWENTY_HOURS', 'TWENTY_HOURS'), ('FORTY_HOURS', 'FORTY_HOURS'), ('RDE', 'RDE'), ('TEMPORARY', 'TEMPORARY'), ('SUBSTITUTE', 'SUBSTITUTE')], max_length=45, null=True, verbose_name='job')),
        ...
        migrations.CreateModel(
            name='AcademicDegreeHistory',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('academic_degree', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.academicdegree')),
            ],
        ),
        migrations.CreateModel(
            name='Job',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_degrees', models.ManyToManyField(blank=True, through='user.AcademicDegreeHistory', to='user.academicdegree')),
            ],
        ),
        migrations.AddField(
            model_name='academicdegreehistory',
            name='history',
