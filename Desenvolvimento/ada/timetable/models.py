...
class Timeslot(models.Model):
    ...
    def clean(self):
        super().clean()
        # validação hora início maior que a hora fim, validação hora início
        # igual hora fim
        validate_incongruity_time(self)
        # validação uma hora em cima da outra, validação mesma hora
        validate_interrupted_time(Timeslot, self)
