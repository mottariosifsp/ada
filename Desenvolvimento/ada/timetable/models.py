...
from common.validator.validator import validate_start_greater_end, validate_interrupted_time
...
class Timeslot(models.Model):
    ...
    def clean(self):
        super().clean()
        validate_start_greater_end(self) # validação hora início maior que a hora fim
